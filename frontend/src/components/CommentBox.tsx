...
export default function CommentBox({ pieceId }: Props) {
    // from firebase
    ...
    useEffect(() => {
        const unsubscribe = onValue(ref(getDatabase(), `/pieces/${pieceId}/comments`), (snapshot) => {
    ...
    return <div className="p-2" >
        {
            ...
            <div
                children={commentIds.map((cid, i) => {
                    ...
                    return <div
                        key={i}
                        className="bg-gray-100 m-2 p-2 rounded-lg flex"
                    >
                        <div className="flex-1">
                            ...
                            <p children={content} />
                            {
                                ...
                                <div>
                                    {
                                        innerComments && innerCommentKeys.map(icid => (
                                            <div
                                                key={icid}
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                if(!isEmpty(editorContent)) {
                                                    ...
                                                    push(
                                                        ref(getDatabase(), `/pieces/${pieceId}/comments/${cid}/innerComments`),
                                                        comment
                                                    )
                        ...
                        <div
                            onClick={() => {
                                setSelectedCommentId(v => cid !== selectedCommentId ? cid : null)
                            }}
                        >
                            <svg
                ...
                <button
                    ...
                    onClick={() => {
                        if(!isEmpty(editorContent)) {
                            ...
                            push(
                                ref(getDatabase(), `/pieces/${pieceId}/comments`),
                                comment
                            )
