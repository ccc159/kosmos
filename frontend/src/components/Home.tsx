...
export function Home() {
  ...
  return (
    <motion.div className='p-3'>
      <h1 className='text-2xl font-bold fixed top-0 h-14 w-screen bg-white flex items-center z-20'>Paul Klee Kosmos</h1>
      {pieces.length > 0 && (
        <motion.ul className='piece-container' variants={containerVariants} initial='hidden' animate='visible'>
          {pieces
